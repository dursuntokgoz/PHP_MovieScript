...
class TMDb {
     ...
     * @return void
     */
    public function __construct($apikey, $config = false, $scheme = TMDb::API_SCHEME) {
        // Load config file
        $this->_obj = &get_instance();
        $this->_obj->load->config('tmdb');

        //Assign Api Key
        $this->_apikey = (string) $this->_obj->config->item('tmdbapi');
     ...
     * @return TMDb result array
     */
    public function getTVShow($id, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getTVShowSeason($id, $season_number, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
        return $this->_makeCall('tv/'. $id.'/season/'. $season_number, $params);
    }
     ...
     * @return TMDb result array
     */
    public function getTVShowEpisode($id, $season_number, $episode_number, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
        return $this->_makeCall('tv/'. $id.'/season/'. $season_number .'/episode/'. $episode_number, $params);
    }
     ...
     * @return TMDb result array
     */
    public function getMovieExternealIDs($id) {
        return $this->_makeCall('movie/' . $id . '/external_ids');
    }
     ...
     * @return TMDb result array
     */
    public function getTVShowExternealIDs($id) {
        return $this->_makeCall('tv/' . $id . '/external_ids');
    }
     ...
     * @return TMDb result array
     */
    public function getTVShowEpisodeExternealIDs($id, $season, $episode) {
        return $this->_makeCall('tv/' . $id .'/season/'.$season.'/episode/'.$episode.'/external_ids');
    }	
     ...
     * @return TMDb result array
     */
    public function getTVShowCast($id) {
     ...
     * @return TMDb result array
     */
    public function getTVShowKeywords($id) {
     ...
     * @return TMDb result array
     */
    public function getMovieTrailers($id, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getTVShowTrailers($id, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMovieImages($id, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getTVShowImages($id, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getSimilarMovies($id, $page = 1, $lang = false) {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getUpcomingMovies($page = 1, $lang = false) {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getNowPlayingMovies($page = 1, $lang = false) {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getPopularMovies($page = 1, $lang = false) {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getTopRatedMovies($page = 1, $lang = false) {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getPersonCredits($id, $lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMoviesByCompany($id, $page = 1, $lang = false) {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMovieGenres($lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
    ...
    public function getTVShowGenres($lang = false) {
        $params = array(
            'language' => ($lang !== null) ? $lang : false,
        );
     ...
     * @return TMDb result array
     */
    public function getMoviesByGenre($id, $page = 1, $lang = false) {
        $params = array(
            'page' => (int) $page,
            'language' => ($lang !== null) ? $lang : false,
        );
