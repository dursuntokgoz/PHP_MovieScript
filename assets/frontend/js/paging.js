	...
	$.paging = function(el, options, index) {
		...
		var _pagerButtons = {
			getFirstButton: function(text) {
				return '<button class="first" type="button">' + (text || "İlk") + '</button>';
			},
			getLastButton: function(text) {
				return '<button class="last" type="button">' + (text || "Son") + '</button>';
			},
			getPrevButton: function(text) {
				return '<button class="prev" type="button">' + (text || "Önceki") + '</button>';
			},
			getNextButton: function(text) {
				return '<button class="next" type="button">' + (text || "Sonraki") + '</button>';
			},
